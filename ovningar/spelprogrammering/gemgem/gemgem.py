...
DEDUCTSPEED = 0.2 # reduces score by 1 point every DEDUCTSPEED seconds.
...
def main():
    ...
    for i in range(1, NUMGEMIMAGES+1):
        gemImage = pygame.image.load('ovningar/spelprogrammering/gemgem/gem%s.png' % i)
    ...
    # Load the sounds.
    GAMESOUNDS = {}
    GAMESOUNDS['bad swap'] = pygame.mixer.Sound('ovningar/spelprogrammering/gemgem/badswap.wav')
    GAMESOUNDS['match'] = []
    for i in range(NUMMATCHSOUNDS):
        GAMESOUNDS['match'].append(pygame.mixer.Sound('ovningar/spelprogrammering/gemgem/match%s.wav' % i))
