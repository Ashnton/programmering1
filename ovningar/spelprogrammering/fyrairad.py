...
def main():
    ...
    REDTOKENIMG = pygame.image.load('ovningar/spelprogrammering/filip.png')
    REDTOKENIMG = pygame.transform.smoothscale(REDTOKENIMG, (SPACESIZE, SPACESIZE))
    BLACKTOKENIMG = pygame.image.load('ovningar/spelprogrammering/leo.png')
    BLACKTOKENIMG = pygame.transform.smoothscale(BLACKTOKENIMG, (SPACESIZE, SPACESIZE))
    BOARDIMG = pygame.image.load('ovningar/spelprogrammering/4row_board.png')
    BOARDIMG = pygame.transform.smoothscale(BOARDIMG, (SPACESIZE, SPACESIZE))

    HUMANWINNERIMG = pygame.image.load('ovningar/spelprogrammering/4row_humanwinner.png')
    COMPUTERWINNERIMG = pygame.image.load('ovningar/spelprogrammering/4row_computerwinner.png')
    TIEWINNERIMG = pygame.image.load('ovningar/spelprogrammering/4row_tie.png')
    WINNERRECT = HUMANWINNERIMG.get_rect()
    WINNERRECT.center = (int(WINDOWWIDTH / 2), int(WINDOWHEIGHT / 2))

    ARROWIMG = pygame.image.load('ovningar/spelprogrammering/4row_arrow.png')
